...
export const metadata: Metadata = {
  title: 'AI Voice Agent Services for Plano Businesses | Forsythe Publishing',
  description: 'Boost lead conversion with AI voice agents in Plano. 70% contact rate, 2-5 min response times. Perfect for roofing, HVAC, plumbing & more in Plano, TX.',
  keywords: 'AI voice agent Plano, Plano lead conversion, roofing AI callback, HVAC lead automation, Plano marketing automation, AI receptionist Texas',
  openGraph: {
    title: 'AI Voice Agent Services for Plano Businesses',
    description: 'Boost lead conversion with AI voice agents in Plano. 70% contact rate, 2-5 min response times.',
    type: 'website',
    locale: 'en_US',
    siteName: 'Forsythe Publishing & Marketing',
    url: 'https://forsythepublishing.com/plano',
  },
};
...
export default function PlanoPage() {
  return (
    <div className="min-h-screen bg-[#0b0c0d] text-slate-100">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#d9c4aa]/30 bg-[#d9c4aa]/10 text-[#d9c4aa] font-sans uppercase text-[10px] tracking-[0.12em] mb-6">
              ...
              <span>PLANO SERVICE BUSINESSES</span>
            </div>
            <h1 className="font-display text-[#d9c4aa] uppercase tracking-[0.15em] text-3xl md:text-5xl mb-6">
              AI Voice Agents for <span className="text-white">Plano</span> Service Companies
            </h1>
            <p className="text-slate-300/90 text-lg mb-8">
              Increase your lead conversion rate with our AI voice agents designed specifically for Plano service businesses. From roofing to HVAC, plumbing to solar, we help you capture more leads and book more appointments in the Plano area.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            <h2 className="font-display text-[#d9c4aa] uppercase tracking-[0.18em] text-2xl md:text-3xl mb-4">
              Serving Plano and <span className="text-white">Surrounding Areas</span>
            </h2>
            <p className="text-slate-300 max-w-2xl mx-auto">
              We specialize in helping Plano service businesses increase their lead conversion rates with AI voice agents.
            </p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-[#111315] rounded-2xl p-8 border border-white/10">
              <h3 className="font-display text-white uppercase tracking-[0.22em] text-xl mb-4">Downtown Plano</h3>
              <p className="text-slate-300/90 mb-4">
                Supporting the vibrant downtown Plano area with AI voice agents that capture leads and book appointments quickly for commercial and residential services.
              </p>
              <ul className="space-y-2 text-slate-300/80">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-[#d9c4aa]">•</span>
                  <span>Corporate Campus Support</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#d9c4aa]">•</span>
                  <span>Restaurant & Retail Services</span>
                </li>
              </ul>
            </div>

            <div className="bg-[#111315] rounded-2xl p-8 border border-white/10">
              <h3 className="font-display text-white uppercase tracking-[0.22em] text-xl mb-4">Legacy West</h3>
              <p className="text-slate-300/90 mb-4">
                Helping Legacy West businesses convert more leads with our smart AI voice agents that respond in under 5 minutes during business hours and after-hours.
              </p>
              <ul className="space-y-2 text-slate-300/80">
                <li className="flex items-start gap-2">
                  <span className="text-[#d9c4aa]">•</span>
                  <span>Enterprise Level Services</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#d9c4aa]">•</span>
                ...
                <li className="flex items-start gap-2">
                  <span className="text-[#d9c4aa]">•</span>
                  <span>Executive Level Support</span>
                </li>
              </ul>
            </div>

            <div className="bg-[#111315] rounded-2xl p-8 border border-white/10">
              <h3 className="font-display text-white uppercase tracking-[0.22em] text-xl mb-4">West Plano</h3>
              <p className="text-slate-300/90 mb-4">
                Supporting West Plano businesses with 24/7 AI voice agent coverage across all service areas, ensuring no leads are missed in this affluent area.
              </p>
              <ul className="space-y-2 text-slate-300/80">
                <li className="flex items-start gap-2">
                  <span className="text-[#d9c4aa]">•</span>
                ...
                <li className="flex items-start gap-2">
                  <span className="text-[#d9c4aa]">•</span>
                  <span>Holiday Availability</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#d9c4aa]">•</span>
      ...
      {/* Plano Industry Focus */}
      <section className="py-16 md:py-24 bg-[#111315]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            <h2 className="font-display text-[#d9c4aa] uppercase tracking-[0.18em] text-2xl md:text-3xl mb-4">
              Industry-Specific AI Solutions for <span className="text-white">Plano</span>
            </h2>
            <p className="text-slate-300 max-w-2xl mx-auto">
              Our AI voice agents are customized for each industry common to the Plano market.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-[#0f1112] rounded-2xl p-6 border border-white/10 hover:border-[#d9c4aa]/30 transition-all">
              ...
              <p className="text-slate-300/90 mb-4">
                Handles storm damage claims, insurance questions, and schedules inspections. Specialized for Plano's seasonal weather patterns.
              </p>
            ...
            <div className="bg-[#0f1112] rounded-2xl p-6 border border-white/10 hover:border-[#d9c4aa]/30 transition-all">
              ...
              <p className="text-slate-300/90 mb-4">
                Schedules emergency repairs, handles seasonal maintenance, and qualifies leads for high-value installations in Plano's climate.
              </p>
              <ul className="space-y-2 text-slate-300/80 text-sm">
                <li className="flex items-start gap-2">
                  <span className="text-[#d9c4aa]">•</span>
            ...
            <div className="bg-[#0f1112] rounded-2xl p-6 border border-white/10 hover:border-[#d9c4aa]/30 transition-all">
              ...
              <p className="text-slate-300/90 mb-4">
                Triage emergency situations, schedule service calls, and provide immediate quotes for common issues in Plano homes.
              </p>
              <ul className="space-y-2 text-slate-300/80 text-sm">
                <li className="flex items-start gap-2">
                  <span className="text-[#d9c4aa]">•</span>
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            <h2 className="font-display text-[#d9c4aa] uppercase tracking-[0.18em] text-2xl md:text-3xl mb-4">
              Plano Businesses <span className="text-white">Seeing Results</span>
            </h2>
            <p className="text-slate-300 max-w-2xl mx-auto">
              Real Plano businesses increasing their lead conversion with our AI voice agents.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-[#111315] rounded-2xl p-6 border border-white/10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <div className="text-[#d9c4aa] text-xs">Plano Roofing Solutions</div>
                </div>
              </div>
              <p className="text-slate-300/90 mb-4">
                "We went from 35% to 70% contact rate in the first month in Plano. The AI agent never sleeps and catches leads we used to miss during storm season."
              </p>
            ...
            <div className="bg-[#111315] rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-slate-300/90 mb-4">
                "The inbound AI handles our Plano emergency calls perfectly. It triages urgent issues and routes them to the right technician. Our response time improved by 80%."
              </p>
              <div className="flex items-center gap-3 text-sm">
            ...
            <div className="bg-[#111315] rounded-2xl p-6 border border-white/10">
              ...
              <p className="text-slate-300/90 mb-4">
                "Our custom video ads are driving 3x more qualified leads in Plano. The AI voice agent books consultations while we're in court. It's like having a 24/7 receptionist."
              </p>
              <div className="flex items-center gap-3 text-sm">
      ...
      <section id="contact" className="py-16 md:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <div className="bg-gradient-to-br from-[#d9c4aa]/10 to-[#b89463]/10 rounded-2xl p-8 border border-[#d9c4aa]/20">
            <h2 className="font-display text-[#d9c4aa] uppercase tracking-[0.18em] text-2xl md:text-3xl mb-4">
              Ready to Transform Your <span className="text-white">Plano Business</span>?
            </h2>
            <p className="text-slate-300 mb-8 max-w-2xl mx-auto">
              Join the dozens of Plano service businesses using our AI voice agents to capture more leads and book more appointments. Start your 5-day free trial today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="tel:+18172108487" 
      ...
      <footer className="border-t border-white/10 bg-[#111315]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 grid md:grid-cols-3 gap-6">
          <div>
            ...
            <p className="text-slate-300/80 ui-track">AI voice agents for Plano service businesses.</p>
            <div className="text-[#d9c4aa] font-display uppercase tracking-[var(--ls-sub)]">Plano, Texas · Serving DFW</div>
          </div>
          <div>
